...
python .openapi-generator/post_gen_script.py "https://github.com/ladybug-tools/honeybee-schema/releases/download/$VERSION/simulation-parameter.json"
python .openapi-generator/post_gen_script.py "https://github.com/ladybug-tools/honeybee-schema/releases/download/$VERSION/model.json"
