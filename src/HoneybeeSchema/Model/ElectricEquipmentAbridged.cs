...
namespace HoneybeeSchema
{
    ...
    public partial class ElectricEquipmentAbridged : EquipmentBase, IEquatable<ElectricEquipmentAbridged>
    {
        /// <summary>
        ...
        (
            double wattsPerArea, string schedule, string identifier, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D, object userData = default, string displayName = default
        ) : base(wattsPerArea: wattsPerArea, schedule: schedule, radiantFraction: radiantFraction, latentFraction: latentFraction, lostFraction: lostFraction, userData: userData, identifier: identifier, displayName: displayName)
        {
