...
namespace HoneybeeSchema
{
    ...
    public partial class ElectricEquipmentAbridged :  IEquatable<ElectricEquipmentAbridged>, IValidatableObject
    {
        ...
        public ElectricEquipmentAbridged(string identifier, string displayName = default, double wattsPerArea, string schedule, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D)
        {
