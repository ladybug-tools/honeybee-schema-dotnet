...
namespace HoneybeeSchema
{
    ...
    public partial class Baseboard : IDdEnergyBaseModel, IEquatable<Baseboard>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Object userData= default, Vintages vintage= Vintages.ASHRAE_2019, BaseboardEquipmentType equipmentType= BaseboardEquipmentType.ElectricBaseboard// Optional parameters
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^Baseboard$", RegexOptions.CultureInvariant);
