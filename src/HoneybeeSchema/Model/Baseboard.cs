...
namespace HoneybeeSchema
{
    ...
    public partial class Baseboard : IDdEnergyBaseModel, IEquatable<Baseboard>
    {
        /// <summary>
        ...
        /// <param name="equipmentType">Text for the specific type of system equipment from the BaseboardEquipmentType enumeration.</param>
        public Baseboard
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, BaseboardEquipmentType equipmentType = BaseboardEquipmentType.ElectricBaseboard
        ) : base(userData: userData, identifier: identifier, displayName: displayName)
        {
            ...
            if (this.GetType() == typeof(Baseboard))
        ...
        /// </summary>
        [Summary(@"Text for the specific type of system equipment from the BaseboardEquipmentType enumeration.")]
        [DataMember(Name = "equipment_type")]
        public BaseboardEquipmentType EquipmentType { get; set; } = BaseboardEquipmentType.ElectricBaseboard;
        ...
        /// </summary>
        /// <returns>Baseboard object</returns>
        public static Baseboard FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<Baseboard>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>Baseboard object</returns>
        public virtual Baseboard DuplicateBaseboard()
        {
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as Baseboard);
        }


        /// <summary>
        /// Returns true if Baseboard instances are equal
        /// </summary>
        /// <param name="input">Instance of Baseboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Baseboard input)
        {
            if (input == null)
                return false;
