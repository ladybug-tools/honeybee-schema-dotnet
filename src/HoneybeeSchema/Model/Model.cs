...
namespace HoneybeeSchema
{
    ...
    public partial class Model :  IEquatable<Model>, IValidatableObject
    {
        ...
        public Model(string identifier, string displayName = default, Object userData = default, List<Room> rooms = default, List<Face> orphanedFaces = default, List<Shade> orphanedShades = default, List<Aperture> orphanedApertures = default, List<Door> orphanedDoors = default, double northAngle = 0D, UnitsEnum? units = UnitsEnum.Meters, double tolerance = 0D, double angleTolerance = 0D, ModelProperties properties)
        {
