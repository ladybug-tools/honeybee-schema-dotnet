...
namespace HoneybeeSchema
{
    ...
    public partial class Model : IDdBaseModel, IEquatable<Model>, IValidatableObject
    {
        ...
        /// <param name="version">Text string for the current version of the schema. (default to &quot;1.39.2&quot;).</param>
