...
namespace HoneybeeSchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class PSZ : TemplateSystem, IEquatable<PSZ>, IValidatableObject
    {
        ...
        public PSZEquipmentType? EquipmentType { get; set; }   
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages? vintage= default, AllAirEconomizerType? economizerType= default, AnyOf<Autosize,double> sensibleHeatRecovery= default, AnyOf<Autosize,double> latentHeatRecovery= default, PSZEquipmentType? equipmentType= default// Optional parameters
        ...
        /// </summary>
        /// <returns>PSZ object</returns>
        public PSZ DuplicatePSZ()
        {
            return Duplicate() as PSZ;
        }
