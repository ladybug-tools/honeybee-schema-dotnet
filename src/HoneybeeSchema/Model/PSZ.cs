...
namespace HoneybeeSchema
{
    ...
    public partial class PSZ : IDdEnergyBaseModel, IEquatable<PSZ>
    {
        /// <summary>
        ...
        public PSZ
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, AllAirEconomizerType economizerType = AllAirEconomizerType.NoEconomizer, double sensibleHeatRecovery = 0D, double latentHeatRecovery = 0D, bool demandControlledVentilation = false, PSZEquipmentType equipmentType = PSZEquipmentType.PSZAC_ElectricBaseboard
