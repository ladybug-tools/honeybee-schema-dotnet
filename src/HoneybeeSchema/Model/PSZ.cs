...
namespace HoneybeeSchema
{
    ...
    public partial class PSZ : IDdEnergyBaseModel, IEquatable<PSZ>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.ASHRAE_2013, AllAirEconomizerType economizerType= AllAirEconomizerType.NoEconomizer, double sensibleHeatRecovery = 0D, double latentHeatRecovery = 0D, bool demandControlledVentilation = false, PSZEquipmentType equipmentType= PSZEquipmentType.PSZAC_ElectricBaseboard// Optional parameters
