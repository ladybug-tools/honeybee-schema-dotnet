...
namespace HoneybeeSchema
{
    ...
    public partial class Trans : ModifierBase, IEquatable<Trans>, IValidatableObject
    {
        ...
        /// <param name="specularity">A value between 0 and 1 for the fraction of specularity. Specularity fractions greater than 0.1 are not realistic. (default: 0). (default to 0D).</param>
        ...
        (
            ...
            string displayName= default, AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Void,Mirror> modifier= default, List<AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Void,Mirror>> dependencies= default, double rReflectance = 0.0D, double gReflectance = 0.0D, double bReflectance = 0.0D, double specularity = 0D, double roughness = 0D, double transmittedDiff = 0D, double transmittedSpec = 0D // Optional parameters
        ...
        public double RReflectance { get; set; }
        /// <summary>
        ...
        public double GReflectance { get; set; }
        /// <summary>
        ...
        public double BReflectance { get; set; }
        /// <summary>
        /// A value between 0 and 1 for the fraction of specularity. Specularity fractions greater than 0.1 are not realistic. (default: 0).
        /// </summary>
        /// <value>A value between 0 and 1 for the fraction of specularity. Specularity fractions greater than 0.1 are not realistic. (default: 0).</value>
        ...
        public double TransmittedDiff { get; set; }
        /// <summary>
        ...
        public double TransmittedSpec { get; set; }
        ...
        {
            return JsonConvert.DeserializeObject<Trans>(json, new AnyOfJsonConverter());
        }
