...
namespace HoneybeeSchema
{
    ...
    public partial class Trans : ModifierBase, IEquatable<Trans>, IValidatableObject
    {
        ...
        (
            ...
            AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Void,Mirror> modifier= default, List<AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Void,Mirror>> dependencies= default, double rReflectance = 0.0D, double gReflectance = 0.0D, double bReflectance = 0.0D, double specularity = 0D, double roughness = 0D, double transmittedDiff = 0D, double transmittedSpec = 0D, string displayName= default// Optional parameters
