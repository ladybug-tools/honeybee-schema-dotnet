...
namespace HoneybeeSchema
{
    ...
    public partial class EnergyMaterial :  IEquatable<EnergyMaterial>, IValidatableObject
    {
        ...
        public EnergyMaterial(string identifier, string displayName = default, RoughnessEnum? roughness = RoughnessEnum.MediumRough, double thickness, double conductivity, double density, double specificHeat, double thermalAbsorptance = 0.9D, double solarAbsorptance = 0.7D, double visibleAbsorptance = 0.7D)
        {
