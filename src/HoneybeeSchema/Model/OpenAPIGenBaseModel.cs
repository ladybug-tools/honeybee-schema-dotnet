...
namespace HoneybeeSchema
{
    ...
    [JsonSubtypes.KnownSubType(typeof(SizingParameter), "SizingParameter")]
    [JsonSubtypes.KnownSubType(typeof(DatedBaseModel), "DatedBaseModel")]
    [JsonSubtypes.KnownSubType(typeof(SimulationControl), "SimulationControl")]
    [JsonSubtypes.KnownSubType(typeof(SimulationParameter), "SimulationParameter")]
    [JsonSubtypes.KnownSubType(typeof(SimulationOutput), "SimulationOutput")]
    [JsonSubtypes.KnownSubType(typeof(HumidityCondition), "HumidityCondition")]
    [JsonSubtypes.KnownSubType(typeof(ShadowCalculation), "ShadowCalculation")]
    [JsonSubtypes.KnownSubType(typeof(SkyCondition), "_SkyCondition")]
    [JsonSubtypes.KnownSubType(typeof(DesignDay), "DesignDay")]
    [JsonSubtypes.KnownSubType(typeof(WindCondition), "WindCondition")]
    [JsonSubtypes.KnownSubType(typeof(DryBulbCondition), "DryBulbCondition")]
