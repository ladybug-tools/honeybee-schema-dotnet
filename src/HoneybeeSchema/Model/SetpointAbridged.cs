...
namespace HoneybeeSchema
{
    ...
    public partial class SetpointAbridged : IDdEnergyBaseModel, IEquatable<SetpointAbridged>
    {
        ...
        (
            string identifier, string coolingSchedule, string heatingSchedule, object userData = default, string displayName = default, string humidifyingSchedule = default, string dehumidifyingSchedule = default, double setpointCutoutDifference = 0D
