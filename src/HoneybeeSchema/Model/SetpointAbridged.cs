...
namespace HoneybeeSchema
{
    ...
    public partial class SetpointAbridged :  IEquatable<SetpointAbridged>, IValidatableObject
    {
        ...
        public SetpointAbridged(string identifier, string displayName = default, string coolingSchedule, string heatingSchedule, string humidifyingSchedule = default, string dehumidifyingSchedule = default)
        {
