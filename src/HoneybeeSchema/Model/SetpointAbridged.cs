...
namespace HoneybeeSchema
{
    ...
    public partial class SetpointAbridged : IDdEnergyBaseModel, IEquatable<SetpointAbridged>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Object userData= default, string humidifyingSchedule= default, string dehumidifyingSchedule= default, double setpointCutoutDifference = 0D// Optional parameters
