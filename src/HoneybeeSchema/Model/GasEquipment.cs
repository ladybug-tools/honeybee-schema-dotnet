...
namespace HoneybeeSchema
{
    ...
    public partial class GasEquipment :  IEquatable<GasEquipment>, IValidatableObject
    {
        ...
        public GasEquipment(string identifier, double wattsPerArea, AnyOfobjectobject schedule, string displayName = default, double radiantFraction = 0, double latentFraction = 0, double lostFraction = 0, string type = "GasEquipment")
        {
