...
namespace HoneybeeSchema
{
    ...
    public partial class GasEquipment : IDdEnergyBaseModel, IEquatable<GasEquipment>, IValidatableObject
    {
        ...
        ) : base(identifier: identifier, displayName: displayName )// BaseClass
        {
            ...
            this.WattsPerArea = wattsPerArea ?? throw new ArgumentNullException("wattsPerArea is a required property for GasEquipment and cannot be null");
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"GasEquipment {iDd.Identifier}";
        ...
        /// </summary>
        /// <returns>GasEquipment object</returns>
        public GasEquipment DuplicateGasEquipment()
        {
            return Duplicate() as GasEquipment;
        }
