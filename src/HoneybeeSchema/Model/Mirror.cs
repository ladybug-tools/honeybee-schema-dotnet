...
namespace HoneybeeSchema
{
    ...
    public partial class Mirror : ModifierBase, IEquatable<Mirror>, IValidatableObject
    {
        ...
        public AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Void,Mirror> AlternateMaterial { get; set; }
        ...
        {
            return JsonConvert.DeserializeObject<Mirror>(json, new AnyOfJsonConverter());
        }
