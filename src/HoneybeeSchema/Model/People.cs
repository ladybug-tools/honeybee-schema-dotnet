...
namespace HoneybeeSchema
{
    ...
    public partial class People : IDdEnergyBaseModel, IEquatable<People>, IValidatableObject
    {
        ...
        /// <param name="activitySchedule">A schedule for the activity of the occupants over the course of the year. The type of this schedule should be Power and the values of the schedule equal to the number of Watts given off by an individual person in the room..</param>
        ...
        (
            ...
            double peoplePerArea= default, AnyOf<ScheduleRuleset,ScheduleFixedInterval> occupancySchedule= default, AnyOf<ScheduleRuleset,ScheduleFixedInterval> activitySchedule= default, double radiantFraction = 0.3D, AnyOf<Autocalculate,double> latentFraction= default, string displayName= default// Optional parameters
