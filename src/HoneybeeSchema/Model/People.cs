...
namespace HoneybeeSchema
{
    ...
    public partial class People : IDdEnergyBaseModel, IEquatable<People>
    {
        /// <summary>
        ...
        public People
        (
            string identifier, double peoplePerArea, AnyOf<ScheduleRuleset, ScheduleFixedInterval> occupancySchedule, object userData = default, string displayName = default, AnyOf<ScheduleRuleset, ScheduleFixedInterval> activitySchedule = default, double radiantFraction = 0.3D, AnyOf<Autocalculate, double> latentFraction = default
