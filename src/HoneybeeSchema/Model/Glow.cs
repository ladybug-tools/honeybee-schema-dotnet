...
namespace HoneybeeSchema
{
    ...
    public partial class Glow : ModifierBase, IEquatable<Glow>, IValidatableObject
    {
        ...
        (
            ...
            AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Void,Mirror> modifier= default, List<AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Void,Mirror>> dependencies= default, double rEmittance = 0.0D, double gEmittance = 0.0D, double bEmittance = 0.0D, double maxRadius = 0D, string displayName= default// Optional parameters
