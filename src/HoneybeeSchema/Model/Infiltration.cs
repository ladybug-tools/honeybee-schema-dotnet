...
namespace HoneybeeSchema
{
    ...
    public partial class Infiltration : IDdEnergyBaseModel, IEquatable<Infiltration>, IValidatableObject
    {
        ...
        (
            ...
            double flowPerExteriorArea= default, AnyOf<ScheduleRuleset,ScheduleFixedInterval> schedule= default, double constantCoefficient = 1D, double temperatureCoefficient = 0D, double velocityCoefficient = 0D, string displayName= default// Optional parameters
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"Infiltration {iDd.Identifier}";
