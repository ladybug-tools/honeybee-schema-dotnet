...
namespace HoneybeeSchema
{
    ...
    public partial class Infiltration : IDdEnergyBaseModel, IEquatable<Infiltration>, IValidatableObject
    {
        ...
        {
            return JsonConvert.DeserializeObject<Infiltration>(json, JsonSetting.AnyOfConvertSetting);
        }
        ...
        /// </summary>
        /// <returns>Infiltration object</returns>
        public Infiltration DuplicateInfiltration()
        {
            return Duplicate() as Infiltration;
        }
