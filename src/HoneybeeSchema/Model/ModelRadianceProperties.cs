...
namespace HoneybeeSchema
{
    ...
    public partial class ModelRadianceProperties : HoneybeeObject, IEquatable<ModelRadianceProperties>, IValidatableObject
    {
        ...
        (
             // Required parameters
            List<AnyOf<Plastic,Glass,BSDF,Glow,Light,Trans,Metal,Void,Mirror>> modifiers= default, List<AnyOf<ModifierSet,ModifierSetAbridged>> modifierSets= default// Optional parameters
        )// BaseClass
        {
