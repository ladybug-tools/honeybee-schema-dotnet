...
namespace HoneybeeSchema
{
    ...
    public partial class ProgramTypeAbridged : IDdEnergyBaseModel, IEquatable<ProgramTypeAbridged>
    {
        /// <summary>
