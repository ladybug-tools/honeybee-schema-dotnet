...
namespace HoneybeeSchema
{
    ...
    public partial class GasEquipmentAbridged :  IEquatable<GasEquipmentAbridged>, IValidatableObject
    {
        ...
        public GasEquipmentAbridged(string identifier, string displayName = default, double wattsPerArea, string schedule, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D)
        {
