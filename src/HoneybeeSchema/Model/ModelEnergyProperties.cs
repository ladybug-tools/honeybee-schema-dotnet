...
namespace HoneybeeSchema
{
    ...
    public partial class ModelEnergyProperties : HoneybeeObject, IEquatable<ModelEnergyProperties>, IValidatableObject
    {
        ...
        (
            // Required parameters
            TerrainTypeEnum? terrainType = TerrainTypeEnum.City, string globalConstructionSet= default, List<ConstructionSetAbridged> constructionSets= default, List<AnyOf<OpaqueConstructionAbridged,WindowConstructionAbridged,ShadeConstruction,AirBoundaryConstructionAbridged>> constructions= default, List<AnyOf<EnergyMaterial,EnergyMaterialNoMass,EnergyWindowMaterialGas,EnergyWindowMaterialGasCustom,EnergyWindowMaterialGasMixture,EnergyWindowMaterialSimpleGlazSys,EnergyWindowMaterialBlind,EnergyWindowMaterialGlazing,EnergyWindowMaterialShade>> materials= default, List<IdealAirSystemAbridged> hvacs= default, List<ProgramTypeAbridged> programTypes= default, List<AnyOf<ScheduleRulesetAbridged,ScheduleFixedIntervalAbridged>> schedules= default, List<ScheduleTypeLimit> scheduleTypeLimits= default// Optional parameters
        )// BaseClass
        {
