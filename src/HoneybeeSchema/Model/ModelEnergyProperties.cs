...
namespace HoneybeeSchema
{
    ...
    public partial class ModelEnergyProperties :  IEquatable<ModelEnergyProperties>, IValidatableObject
    {
        ...
        public ModelEnergyProperties(string type = "ModelEnergyProperties", TerrainTypeEnum? terrainType = TerrainTypeEnum.City, string globalConstructionSet = default, List<ConstructionSetAbridged> constructionSets = default, List<AnyOfOpaqueConstructionAbridgedWindowConstructionAbridgedShadeConstructionAirBoundaryConstructionAbridged> constructions = default, List<AnyOfEnergyMaterialEnergyMaterialNoMassEnergyWindowMaterialGasEnergyWindowMaterialGasCustomEnergyWindowMaterialGasMixtureEnergyWindowMaterialSimpleGlazSysEnergyWindowMaterialBlindEnergyWindowMaterialGlazingEnergyWindowMaterialShade> materials = default, List<IdealAirSystemAbridged> hvacs = default, List<ProgramTypeAbridged> programTypes = default, List<AnyOfScheduleRulesetAbridgedScheduleFixedIntervalAbridged> schedules = default, List<ScheduleTypeLimit> scheduleTypeLimits = default)
        {
