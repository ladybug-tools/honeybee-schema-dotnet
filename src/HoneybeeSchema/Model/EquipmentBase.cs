...
namespace HoneybeeSchema
{
    ...
    public partial class EquipmentBase : IDdEnergyBaseModel, IEquatable<EquipmentBase>
    {
        /// <summary>
        ...
        (
            string identifier, double wattsPerArea, string schedule, object userData = default, string displayName = default, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D
