...
namespace HoneybeeSchema
{
    ...
    public partial class SimulationParameter : HoneybeeObject, IEquatable<SimulationParameter>, IValidatableObject
    {
        ...
        (
             // Required parameters
            SimulationOutput output= default, RunPeriod runPeriod= default, int timestep = 6, SimulationControl simulationControl= default, ShadowCalculation shadowCalculation= default, SizingParameter sizingParameter= default, double northAngle = 0D, TerrainTypeEnum? terrainType = TerrainTypeEnum.City// Optional parameters
        )// BaseClass
        {
            this.Output = output;
