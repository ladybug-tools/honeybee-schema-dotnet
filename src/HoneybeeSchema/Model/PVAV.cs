...
namespace HoneybeeSchema
{
    ...
    public partial class PVAV : IDdEnergyBaseModel, IEquatable<PVAV>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.ASHRAE_2013, AllAirEconomizerType economizerType= AllAirEconomizerType.Inferred, AnyOf<Autosize,double> sensibleHeatRecovery= default, AnyOf<Autosize,double> latentHeatRecovery= default, PVAVEquipmentType equipmentType= PVAVEquipmentType.PVAV_Boiler// Optional parameters
