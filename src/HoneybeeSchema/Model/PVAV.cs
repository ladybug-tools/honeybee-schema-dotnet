...
namespace HoneybeeSchema
{
    ...
    public partial class PVAV : IEquatable<PVAV>, IValidatableObject
    {
        /// <summary>
        ...
        public PVAVEquipmentType EquipmentType { get; set; } = PVAVEquipmentType.PVAV with gas boiler reheat;
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.90.1-2013, AllAirEconomizerType economizerType= AllAirEconomizerType.Inferred, AnyOf<Autosize,double> sensibleHeatRecovery= default, AnyOf<Autosize,double> latentHeatRecovery= default, PVAVEquipmentType equipmentType= PVAVEquipmentType.PVAV with gas boiler reheat// Optional parameters
        )// BaseClass
        {
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for PVAV and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "PVAV";
