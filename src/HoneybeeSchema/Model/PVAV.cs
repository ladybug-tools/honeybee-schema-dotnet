...
namespace HoneybeeSchema
{
    ...
    public partial class PVAV : IDdEnergyBaseModel, IEquatable<PVAV>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.ASHRAE_2013, AllAirEconomizerType economizerType= AllAirEconomizerType.NoEconomizer, double sensibleHeatRecovery = 0D, double latentHeatRecovery = 0D, bool demandControlledVentilation = false, PVAVEquipmentType equipmentType= PVAVEquipmentType.PVAV_Boiler// Optional parameters
