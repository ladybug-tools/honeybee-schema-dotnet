...
namespace HoneybeeSchema
{
    ...
    public partial class PVAV : IDdEnergyBaseModel, IEquatable<PVAV>
    {
        ...
        public PVAV
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, AllAirEconomizerType economizerType = AllAirEconomizerType.NoEconomizer, double sensibleHeatRecovery = 0D, double latentHeatRecovery = 0D, bool demandControlledVentilation = false, PVAVEquipmentType equipmentType = PVAVEquipmentType.PVAV_Boiler
