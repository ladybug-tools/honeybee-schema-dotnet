...
namespace HoneybeeSchema
{
    ...
    public partial class ForcedAirFurnace : IEquatable<ForcedAirFurnace>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Text for the specific type of system equipment from the FurnaceEquipmentType enumeration.</value>
        [DataMember(Name="equipment_type", EmitDefaultValue=false)]
        public FurnaceEquipmentType EquipmentType { get; set; } = FurnaceEquipmentType.Forced air furnace;
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.90.1-2013, AllAirEconomizerType economizerType= AllAirEconomizerType.Inferred, AnyOf<Autosize,double> sensibleHeatRecovery= default, AnyOf<Autosize,double> latentHeatRecovery= default, FurnaceEquipmentType equipmentType= FurnaceEquipmentType.Forced air furnace// Optional parameters
        )// BaseClass
        {
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for ForcedAirFurnace and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "ForcedAirFurnace";
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^ForcedAirFurnace$", RegexOptions.CultureInvariant);
