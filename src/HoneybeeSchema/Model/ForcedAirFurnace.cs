...
namespace HoneybeeSchema
{
    ...
    public partial class ForcedAirFurnace : IDdEnergyBaseModel, IEquatable<ForcedAirFurnace>
    {
        /// <summary>
        ...
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, FurnaceEquipmentType equipmentType = FurnaceEquipmentType.Furnace
