...
namespace HoneybeeSchema
{
    ...
    public partial class ForcedAirFurnace : IDdEnergyBaseModel, IEquatable<ForcedAirFurnace>, IValidatableObject
    {
        ...
        public FurnaceEquipmentType EquipmentType { get; set; }   
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages vintage= default, AllAirEconomizerType economizerType= default, AnyOf<Autosize,double> sensibleHeatRecovery= default, AnyOf<Autosize,double> latentHeatRecovery= default, FurnaceEquipmentType equipmentType= default// Optional parameters
        ...
        public string Type { get; private set; }  = "ForcedAirFurnace";
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"ForcedAirFurnace {iDd.Identifier}";
