...
namespace HoneybeeSchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class Door :  IEquatable<Door>, IValidatableObject
    {
        /// <summary>
        ...
        public Door(string identifier, Face3D geometry, AnyOf<Outdoors,Surface> boundaryCondition, DoorPropertiesAbridged properties, string displayName = default, Object userData = default, string type = "Door", bool isGlass = false, List<Shade> indoorShades = default, List<Shade> outdoorShades = default)
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for Door and cannot be null");
            }
            else
            {
