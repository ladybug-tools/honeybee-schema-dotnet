...
namespace HoneybeeSchema
{
    ...
    public partial class Door :  IEquatable<Door>, IValidatableObject
    {
        ...
        public Door(string identifier, string displayName = default, Object userData = default, Face3D geometry, AnyOf<Outdoors,Surface> boundaryCondition, bool isGlass = false, List<Shade> indoorShades = default, List<Shade> outdoorShades = default, DoorPropertiesAbridged properties)
        {
