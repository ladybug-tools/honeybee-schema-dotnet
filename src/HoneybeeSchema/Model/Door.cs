...
namespace HoneybeeSchema
{
    ...
    public partial class Door :  IEquatable<Door>, IValidatableObject
    {
        ...
        public Door(string identifier, Face3D geometry, AnyOf<Outdoors,Surface> boundaryCondition, DoorPropertiesAbridged properties, string displayName = default, Object userData = default, bool isGlass = false, List<Shade> indoorShades = default, List<Shade> outdoorShades = default)
        {
