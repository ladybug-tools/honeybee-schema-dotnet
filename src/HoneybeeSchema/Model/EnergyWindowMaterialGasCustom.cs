...
namespace HoneybeeSchema
{
    ...
    public partial class EnergyWindowMaterialGasCustom :  IEquatable<EnergyWindowMaterialGasCustom>, IValidatableObject
    {
        ...
        public EnergyWindowMaterialGasCustom(string identifier, string displayName = default, double thickness = 0.0125D, double conductivityCoeffA, double conductivityCoeffB = 0D, double conductivityCoeffC = 0D, double viscosityCoeffA, double viscosityCoeffB = 0D, double viscosityCoeffC = 0D, double specificHeatCoeffA, double specificHeatCoeffB = 0D, double specificHeatCoeffC = 0D, double specificHeatRatio, double molecularWeight)
        {
