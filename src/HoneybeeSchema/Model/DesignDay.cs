...
namespace HoneybeeSchema
{
    ...
    public partial class DesignDay :  IEquatable<DesignDay>, IValidatableObject
    {
        ...
        public DesignDay(string name, DayTypeEnum dayType, DryBulbCondition dryBulbCondition, HumidityCondition humidityCondition, WindCondition windCondition, AnyOfASHRAEClearSkyASHRAETau skyCondition, string type = "DesignDay")
        {
