...
namespace HoneybeeSchema
{
    ...
    public partial class EnergyMaterialNoMass :  IEquatable<EnergyMaterialNoMass>, IValidatableObject
    {
        ...
        public EnergyMaterialNoMass(string identifier, string displayName = default, double rValue, RoughnessEnum? roughness = RoughnessEnum.MediumRough, double thermalAbsorptance = 0.9D, double solarAbsorptance = 0.7D, double visibleAbsorptance = 0.7D)
        {
