...
namespace HoneybeeSchema
{
    ...
    public partial class WSHP : IDdEnergyBaseModel, IEquatable<WSHP>
    {
        ...
        public WSHP
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, WSHPEquipmentType equipmentType = WSHPEquipmentType.WSHP_FluidCooler_Boiler
