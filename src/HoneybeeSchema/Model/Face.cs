...
namespace HoneybeeSchema
{
    ...
    public partial class Face :  IEquatable<Face>, IValidatableObject
    {
        ...
        public Face(string identifier, Face3D geometry, FaceTypeEnum faceType, AnyOfGroundOutdoorsAdiabaticSurface boundaryCondition, FacePropertiesAbridged properties, string displayName = default, Object userData = default, string type = "Face", List<Aperture> apertures = default, List<Door> doors = default, List<Shade> indoorShades = default, List<Shade> outdoorShades = default)
        {
