...
namespace HoneybeeSchema
{
    ...
    public partial class VRF : IDdEnergyBaseModel, IEquatable<VRF>
    {
        /// <summary>
        ...
        public VRF
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, VRFEquipmentType equipmentType = VRFEquipmentType.VRF
        ...
        /// </summary>
        [Summary(@"Text for the specific type of system equipment from the VRFEquipmentType enumeration.")]
