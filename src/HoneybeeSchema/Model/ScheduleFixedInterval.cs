...
namespace HoneybeeSchema
{
    ...
    public partial class ScheduleFixedInterval : IDdEnergyBaseModel, IEquatable<ScheduleFixedInterval>
    {
        /// <summary>
        ...
        (
            string identifier, List<double> values, object userData = default, string displayName = default, ScheduleTypeLimit scheduleTypeLimit = default, int timestep = 1, List<int> startDate = default, double placeholderValue = 0D, bool interpolate = false
