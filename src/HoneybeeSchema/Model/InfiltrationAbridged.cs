...
namespace HoneybeeSchema
{
    ...
    public partial class InfiltrationAbridged : IDdEnergyBaseModel, IEquatable<InfiltrationAbridged>
    {
        /// <summary>
        ...
        (
            string identifier, double flowPerExteriorArea, string schedule, object userData = default, string displayName = default, double constantCoefficient = 1D, double temperatureCoefficient = 0D, double velocityCoefficient = 0D
