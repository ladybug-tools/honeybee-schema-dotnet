...
namespace HoneybeeSchema
{
    ...
    public partial class InfiltrationAbridged : IDdEnergyBaseModel, IEquatable<InfiltrationAbridged>, IValidatableObject
    {
        ...
        ) : base(identifier: identifier, displayName: displayName )// BaseClass
        {
            ...
            this.FlowPerExteriorArea = flowPerExteriorArea ?? throw new ArgumentNullException("flowPerExteriorArea is a required property for InfiltrationAbridged and cannot be null");
