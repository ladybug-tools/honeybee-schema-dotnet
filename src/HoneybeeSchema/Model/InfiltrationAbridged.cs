...
namespace HoneybeeSchema
{
    ...
    public partial class InfiltrationAbridged :  IEquatable<InfiltrationAbridged>, IValidatableObject
    {
        ...
        public InfiltrationAbridged(string identifier, string displayName = default, double flowPerExteriorArea, string schedule, double constantCoefficient = 1D, double temperatureCoefficient = 0D, double velocityCoefficient = 0D)
        {
