...
namespace HoneybeeSchema
{
    ...
    public partial class VRFwithDOASAbridged : IDdEnergyBaseModel, IEquatable<VRFwithDOASAbridged>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.ASHRAE_2019, double sensibleHeatRecovery = 0D, double latentHeatRecovery = 0D, bool demandControlledVentilation = false, string doasAvailabilitySchedule= default, VRFwithDOASEquipmentType equipmentType= VRFwithDOASEquipmentType.DOAS_VRF// Optional parameters
