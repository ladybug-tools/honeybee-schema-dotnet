...
namespace HoneybeeSchema
{
    ...
    public partial class EvaporativeCooler : IEquatable<EvaporativeCooler>, IValidatableObject
    {
        /// <summary>
        ...
        public EvaporativeCoolerEquipmentType EquipmentType { get; set; } = EvaporativeCoolerEquipmentType.Direct evap coolers with baseboard electric;
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.90.1-2013, EvaporativeCoolerEquipmentType equipmentType= EvaporativeCoolerEquipmentType.Direct evap coolers with baseboard electric// Optional parameters
        )// BaseClass
        {
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for EvaporativeCooler and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "EvaporativeCooler";
