...
namespace HoneybeeSchema
{
    ...
    public partial class EvaporativeCooler : IDdEnergyBaseModel, IEquatable<EvaporativeCooler>
    {
        /// <summary>
        ...
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, EvaporativeCoolerEquipmentType equipmentType = EvaporativeCoolerEquipmentType.EvapCoolers_ElectricBaseboard
