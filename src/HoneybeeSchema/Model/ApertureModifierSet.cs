...
namespace HoneybeeSchema
{
    ...
    public partial class ApertureModifierSet : OpenAPIGenBaseModel, IEquatable<ApertureModifierSet>, IValidatableObject
    {
        ...
        public string Type { get; private set; }  = "ApertureModifierSet";
        /// <summary>
        ...
        /// </summary>
        /// <returns>ApertureModifierSet object</returns>
        public ApertureModifierSet DuplicateApertureModifierSet()
        {
            return FromJson(this.ToJson()) as ApertureModifierSet;
        }
