...
namespace HoneybeeSchema
{
    ...
    public partial class OpaqueConstruction : IEquatable<OpaqueConstruction>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for OpaqueConstruction and cannot be null");
            // to ensure "layers" is required (not null)
            this.Layers = layers ?? throw new ArgumentNullException("layers is a required property for OpaqueConstruction and cannot be null");
