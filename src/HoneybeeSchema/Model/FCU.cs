...
namespace HoneybeeSchema
{
    ...
    public partial class FCU : IDdEnergyBaseModel, IEquatable<FCU>
    {
        /// <summary>
        ...
        public FCU
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, FCUEquipmentType equipmentType = FCUEquipmentType.FCU_Chiller_Boiler
