...
namespace HoneybeeSchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class Autosize : HoneybeeObject, IEquatable<Autosize>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"Autosize {iDd.Identifier}";
        ...
        /// </summary>
        /// <returns>Autosize object</returns>
        public Autosize DuplicateAutosize()
        {
            return Duplicate() as Autosize;
        }
