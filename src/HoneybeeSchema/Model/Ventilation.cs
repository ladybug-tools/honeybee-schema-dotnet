...
namespace HoneybeeSchema
{
    ...
    public partial class Ventilation : IDdEnergyBaseModel, IEquatable<Ventilation>, IValidatableObject
    {
        ...
        {
            return JsonConvert.DeserializeObject<Ventilation>(json, JsonSetting.AnyOfConvertSetting);
        }
        ...
        /// </summary>
        /// <returns>Ventilation object</returns>
        public Ventilation DuplicateVentilation()
        {
            return Duplicate() as Ventilation;
        }
