...
namespace HoneybeeSchema
{
    ...
    public partial class Ventilation : IDdEnergyBaseModel, IEquatable<Ventilation>
    {
        /// <summary>
        ...
        public Ventilation
        (
            string identifier, object userData = default, string displayName = default, double flowPerPerson = 0D, double flowPerArea = 0D, double airChangesPerHour = 0D, double flowPerZone = 0D, AnyOf<ScheduleRuleset, ScheduleFixedInterval> schedule = default
