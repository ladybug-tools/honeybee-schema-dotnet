...
namespace HoneybeeSchema
{
    ...
    public partial class WindowAC : IEquatable<WindowAC>, IValidatableObject
    {
        /// <summary>
        ...
        public WindowACEquipmentType EquipmentType { get; set; } = WindowACEquipmentType.Window AC with baseboard electric;
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.90.1-2013, WindowACEquipmentType equipmentType= WindowACEquipmentType.Window AC with baseboard electric// Optional parameters
        )// BaseClass
        {
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for WindowAC and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "WindowAC";
