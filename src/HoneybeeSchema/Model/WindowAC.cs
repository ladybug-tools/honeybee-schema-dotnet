...
namespace HoneybeeSchema
{
    ...
    public partial class WindowAC : IDdEnergyBaseModel, IEquatable<WindowAC>
    {
        /// <summary>
        ...
        public WindowAC
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, WindowACEquipmentType equipmentType = WindowACEquipmentType.WindowAC_ElectricBaseboard
