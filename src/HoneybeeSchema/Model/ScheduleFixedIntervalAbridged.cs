...
namespace HoneybeeSchema
{
    ...
    public partial class ScheduleFixedIntervalAbridged :  IEquatable<ScheduleFixedIntervalAbridged>, IValidatableObject
    {
        ...
        public ScheduleFixedIntervalAbridged(string identifier, string displayName = default, List<double> values, string scheduleTypeLimit = default, int timestep = 1, List<int> startDate = default, double placeholderValue = 0D, bool interpolate = false)
        {
