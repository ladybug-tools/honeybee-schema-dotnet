...
namespace HoneybeeSchema
{
    ...
    public partial class VentilationControlAbridged : HoneybeeObject, IEquatable<VentilationControlAbridged>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.MinIndoorTemperature = minIndoorTemperature ?? -100D;
            // use default value if no "maxIndoorTemperature" provided
            this.MaxIndoorTemperature = maxIndoorTemperature ?? 100D;
            // use default value if no "minOutdoorTemperature" provided
            this.MinOutdoorTemperature = minOutdoorTemperature ?? -100D;
            // use default value if no "maxOutdoorTemperature" provided
            this.MaxOutdoorTemperature = maxOutdoorTemperature ?? 100D;
            // use default value if no "deltaTemperature" provided
            this.DeltaTemperature = deltaTemperature ?? -100D;
