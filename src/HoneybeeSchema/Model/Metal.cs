...
namespace HoneybeeSchema
{
    ...
    public partial class Metal : ModifierBase, IEquatable<Metal>, IValidatableObject
    {
        ...
        /// <param name="specularity">A value between 0 and 1 for the fraction of specularity. Specularity fractions lower than 0.9 are not realistic for metallic materials. (default to 0.9D).</param>
