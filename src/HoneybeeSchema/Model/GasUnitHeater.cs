...
namespace HoneybeeSchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class GasUnitHeater : HeatCoolBase, IEquatable<GasUnitHeater>, IValidatableObject
    {
        ...
        public GasUnitHeaterEquipmentType? EquipmentType { get; set; }   
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages? vintage= default, GasUnitHeaterEquipmentType? equipmentType= default// Optional parameters
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"GasUnitHeater {iDd.Identifier}";
        ...
        /// </summary>
        /// <returns>GasUnitHeater object</returns>
        public GasUnitHeater DuplicateGasUnitHeater()
        {
            return Duplicate() as GasUnitHeater;
        }
