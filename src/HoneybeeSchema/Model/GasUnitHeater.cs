...
namespace HoneybeeSchema
{
    ...
    public partial class GasUnitHeater : IEquatable<GasUnitHeater>, IValidatableObject
    {
        /// <summary>
        ...
        public GasUnitHeaterEquipmentType EquipmentType { get; set; } = GasUnitHeaterEquipmentType.Gas unit heaters;
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.90.1-2013, GasUnitHeaterEquipmentType equipmentType= GasUnitHeaterEquipmentType.Gas unit heaters// Optional parameters
        )// BaseClass
        {
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for GasUnitHeater and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "GasUnitHeater";
