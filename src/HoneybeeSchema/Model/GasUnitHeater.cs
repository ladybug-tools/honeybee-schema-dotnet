...
namespace HoneybeeSchema
{
    ...
    public partial class GasUnitHeater : IDdEnergyBaseModel, IEquatable<GasUnitHeater>
    {
        /// <summary>
        ...
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, GasUnitHeaterEquipmentType equipmentType = GasUnitHeaterEquipmentType.GasHeaters
