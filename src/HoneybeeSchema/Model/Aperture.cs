...
namespace HoneybeeSchema
{
    ...
    public partial class Aperture :  IEquatable<Aperture>, IValidatableObject
    {
        ...
        public Aperture(string identifier, string displayName = default, Object userData = default, Face3D geometry, AnyOf<Outdoors,Surface> boundaryCondition, bool isOperable = false, List<Shade> indoorShades = default, List<Shade> outdoorShades = default, AperturePropertiesAbridged properties)
        {
