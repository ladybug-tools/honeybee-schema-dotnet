...
namespace HoneybeeSchema
{
    ...
    public partial class Aperture :  IEquatable<Aperture>, IValidatableObject
    {
        ...
        public Aperture(string identifier, Face3D geometry, AnyOf<Outdoors,Surface> boundaryCondition, AperturePropertiesAbridged properties, string displayName = default, Object userData = default, string type = "Aperture", bool isOperable = false, List<Shade> indoorShades = default, List<Shade> outdoorShades = default)
        {
