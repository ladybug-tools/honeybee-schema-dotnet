...
namespace HoneybeeSchema
{
    ...
    public partial class PeopleAbridged :  IEquatable<PeopleAbridged>, IValidatableObject
    {
        ...
        public PeopleAbridged(string identifier, string displayName = default, double peoplePerArea, string occupancySchedule, string activitySchedule, double radiantFraction = 0.3D, AnyOf<Autocalculate,double> latentFraction = default)
        {
