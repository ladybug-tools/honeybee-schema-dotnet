...
namespace HoneybeeSchema
{
    ...
    public partial class PeopleAbridged : IDdEnergyBaseModel, IEquatable<PeopleAbridged>, IValidatableObject
    {
        ...
        [DataMember(Name="people_per_area", EmitDefaultValue=true)]
        ...
        [DataMember(Name="occupancy_schedule", EmitDefaultValue=true)]
        ...
        {
            return FromJson(this.ToJson()) as PeopleAbridged;
        }
