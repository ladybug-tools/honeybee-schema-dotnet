...
namespace HoneybeeSchema
{
    ...
    public partial class WindowConstructionDynamic : IDdEnergyBaseModel, IEquatable<WindowConstructionDynamic>
    {
        /// <summary>
        ...
        (
            string identifier, List<WindowConstruction> constructions, AnyOf<ScheduleRuleset, ScheduleFixedInterval> schedule, object userData = default, string displayName = default
