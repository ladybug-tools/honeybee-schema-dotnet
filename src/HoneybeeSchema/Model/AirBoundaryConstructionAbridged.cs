...
namespace HoneybeeSchema
{
    ...
    public partial class AirBoundaryConstructionAbridged : IDdEnergyBaseModel, IEquatable<AirBoundaryConstructionAbridged>
    {
        /// <summary>
        ...
        (
            string identifier, object userData = default, string displayName = default, double airMixingPerArea = 0.1D, string airMixingSchedule = default
