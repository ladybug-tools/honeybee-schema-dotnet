...
namespace HoneybeeSchema
{
    ...
    public partial class ConstructionSetAbridged : IDdEnergyBaseModel, IEquatable<ConstructionSetAbridged>, IValidatableObject
    {
        ...
        {
            return JsonConvert.DeserializeObject<ConstructionSetAbridged>(json, JsonSetting.AnyOfConvertSetting);
        }
        ...
        /// </summary>
        /// <returns>ConstructionSetAbridged object</returns>
        public ConstructionSetAbridged DuplicateConstructionSetAbridged()
        {
            return Duplicate() as ConstructionSetAbridged;
        }
