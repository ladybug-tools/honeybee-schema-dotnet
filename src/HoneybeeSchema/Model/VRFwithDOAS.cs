...
namespace HoneybeeSchema
{
    ...
    public partial class VRFwithDOAS : IDdEnergyBaseModel, IEquatable<VRFwithDOAS>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.ASHRAE_2013, AnyOf<Autosize,double> sensibleHeatRecovery= default, AnyOf<Autosize,double> latentHeatRecovery= default, VRFwithDOASEquipmentType equipmentType= VRFwithDOASEquipmentType.DOAS_VRF// Optional parameters
        ...
        public override string Type { get; protected set; }  = "VRFwithDOAS";
