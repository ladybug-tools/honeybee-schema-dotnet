...
namespace HoneybeeSchema
{
    ...
    public partial class ScheduleTypeLimit :  IEquatable<ScheduleTypeLimit>, IValidatableObject
    {
        ...
        public ScheduleTypeLimit(string identifier, string displayName = default, string type = "ScheduleTypeLimit", AnyOfNoLimitnumber lowerLimit = default, AnyOfNoLimitnumber upperLimit = default, NumericTypeEnum? numericType = NumericTypeEnum.Continuous, UnitTypeEnum? unitType = UnitTypeEnum.Dimensionless)
        {
