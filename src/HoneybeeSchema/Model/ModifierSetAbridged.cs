...
namespace HoneybeeSchema
{
    ...
    public partial class ModifierSetAbridged : IDdRadianceBaseModel, IEquatable<ModifierSetAbridged>, IValidatableObject
    {
        ...
        /// <param name="airBoundaryModifier">Optional Modifier to be used for all Faces with an AirBoundary face type. If None, it will be the honyebee generic air wall modifier..</param>
        ...
        /// <summary>
        /// Optional Modifier to be used for all Faces with an AirBoundary face type. If None, it will be the honyebee generic air wall modifier.
        /// </summary>
        /// <value>Optional Modifier to be used for all Faces with an AirBoundary face type. If None, it will be the honyebee generic air wall modifier.</value>
