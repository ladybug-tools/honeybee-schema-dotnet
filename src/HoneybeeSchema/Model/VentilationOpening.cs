...
namespace HoneybeeSchema
{
    ...
    public partial class VentilationOpening : HoneybeeObject, IEquatable<VentilationOpening>, IValidatableObject
    {
        ...
        /// <param name="dischargeCoefficient">A number that will be multipled by the area of the window in the stack (buoyancy-driven) part of the equation to account for additional friction from window geometry, insect screens, etc. Typical values include 0.17, for unobstructed windows with insect screens and 0.25 for unobstructed windows without insect screens. This value should be lowered if windows are of an awning or casement type and not allowed to fully open. (default to 0.17D).</param>
        ...
        (
             // Required parameters
            double fractionAreaOperable = 0.5D, double fractionHeightOperable = 1.0D, double dischargeCoefficient = 0.17D, bool windCrossVent = false// Optional parameters
        )// BaseClass
        {
            ...
            {
                this.DischargeCoefficient = 0.17D;
            }
            else
            {
        ...
        /// </summary>
        /// <value>A number that will be multipled by the area of the window in the stack (buoyancy-driven) part of the equation to account for additional friction from window geometry, insect screens, etc. Typical values include 0.17, for unobstructed windows with insect screens and 0.25 for unobstructed windows without insect screens. This value should be lowered if windows are of an awning or casement type and not allowed to fully open.</value>
        [DataMember(Name="discharge_coefficient", EmitDefaultValue=false)]
        [JsonProperty("discharge_coefficient")]
        public double DischargeCoefficient { get; set; }  = 0.17D;
        /// <summary>
