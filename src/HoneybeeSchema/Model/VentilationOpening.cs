...
namespace HoneybeeSchema
{
    ...
    public partial class VentilationOpening : OpenAPIGenBaseModel, IEquatable<VentilationOpening>, IValidatableObject
    {
        ...
        [DataMember(Name = "fraction_area_operable", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "fraction_height_operable", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "discharge_coefficient", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "wind_cross_vent", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "flow_exponent_closed", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "two_way_threshold", EmitDefaultValue = true)]
