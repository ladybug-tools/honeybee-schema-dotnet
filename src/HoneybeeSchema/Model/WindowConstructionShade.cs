...
namespace HoneybeeSchema
{
    ...
    public partial class WindowConstructionShade : IDdEnergyBaseModel, IEquatable<WindowConstructionShade>, IValidatableObject
    {
        ...
        [DataMember(Name="window_construction", EmitDefaultValue=true)]
        ...
        public string Type { get; private set; }  = "WindowConstructionShade";
        /// <summary>
        ...
        {
            return FromJson(this.ToJson()) as WindowConstructionShade;
        }
