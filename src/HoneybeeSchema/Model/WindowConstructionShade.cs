...
namespace HoneybeeSchema
{
    ...
    public partial class WindowConstructionShade : IDdEnergyBaseModel, IEquatable<WindowConstructionShade>
    {
        ...
        (
            string identifier, WindowConstruction windowConstruction, AnyOf<EnergyWindowMaterialShade, EnergyWindowMaterialBlind, EnergyWindowMaterialGlazing> shadeMaterial, object userData = default, string displayName = default, ShadeLocation shadeLocation = ShadeLocation.Interior, ControlType controlType = ControlType.AlwaysOn, double setpoint = default, AnyOf<ScheduleRuleset, ScheduleFixedInterval> schedule = default
