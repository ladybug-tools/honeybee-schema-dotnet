...
namespace HoneybeeSchema
{
    ...
    public partial class WallConstructionSetAbridged :  IEquatable<WallConstructionSetAbridged>, IValidatableObject
    {
        ...
        /// <param name="type">type (default to &quot;WallConstructionSetAbridged&quot;).</param>
        public WallConstructionSetAbridged(string interiorConstruction = default, string exteriorConstruction = default, string groundConstruction = default, string type = "WallConstructionSetAbridged")
        {
