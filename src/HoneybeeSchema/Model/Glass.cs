...
namespace HoneybeeSchema
{
    ...
    public partial class Glass : ModifierBase, IEquatable<Glass>, IValidatableObject
    {
        ...
        public double RTransmissivity { get; set; }
        /// <summary>
        ...
        public double GTransmissivity { get; set; }
        /// <summary>
        ...
        public double BTransmissivity { get; set; }
        /// <summary>
        ...
        {
            return JsonConvert.DeserializeObject<Glass>(json, new AnyOfJsonConverter());
        }
