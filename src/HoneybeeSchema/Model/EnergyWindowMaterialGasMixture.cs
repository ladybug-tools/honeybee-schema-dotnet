...
namespace HoneybeeSchema
{
    ...
    public partial class EnergyWindowMaterialGasMixture :  IEquatable<EnergyWindowMaterialGasMixture>, IValidatableObject
    {
        ...
        public EnergyWindowMaterialGasMixture(string identifier, string displayName = default, double thickness = 0.0125D, List<GasTypesEnum> gasTypes, List<double> gasFractions)
        {
