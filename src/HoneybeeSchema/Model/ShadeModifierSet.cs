...
namespace HoneybeeSchema
{
    ...
    public partial class ShadeModifierSet : HoneybeeObject, IEquatable<ShadeModifierSet>, IValidatableObject
    {
        ...
        {
            return JsonConvert.DeserializeObject<ShadeModifierSet>(json, JsonSetting.AnyOfConvertSetting);
        }
        ...
        /// </summary>
        /// <returns>ShadeModifierSet object</returns>
        public ShadeModifierSet DuplicateShadeModifierSet()
        {
            return Duplicate() as ShadeModifierSet;
        }
