...
namespace HoneybeeSchema
{
    ...
    public partial class LightingAbridged :  IEquatable<LightingAbridged>, IValidatableObject
    {
        ...
        public LightingAbridged(string identifier, string displayName = default, double wattsPerArea, string schedule, double visibleFraction = 0.25D, double radiantFraction = 0.32D, double returnAirFraction = 0.0D)
        {
