...
namespace HoneybeeSchema
{
    ...
    public partial class Residential : IEquatable<Residential>, IValidatableObject
    {
        /// <summary>
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.90.1-2013, ResidentialEquipmentType equipmentType= ResidentialEquipmentType.Residential AC with baseboard electric// Optional parameters
        )// BaseClass
        {
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for Residential and cannot be null");
