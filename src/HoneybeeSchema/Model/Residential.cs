...
namespace HoneybeeSchema
{
    ...
    public partial class Residential : IDdEnergyBaseModel, IEquatable<Residential>
    {
        ...
        public Residential
        (
            string identifier, object userData = default, string displayName = default, Vintages vintage = Vintages.ASHRAE_2019, ResidentialEquipmentType equipmentType = ResidentialEquipmentType.ResidentialAC_ElectricBaseboard
