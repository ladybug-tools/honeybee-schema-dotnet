...
namespace HoneybeeSchema
{
    ...
    public partial class IdealAirSystemAbridged :  IEquatable<IdealAirSystemAbridged>, IValidatableObject
    {
        ...
        public IdealAirSystemAbridged(string identifier, string displayName = default, string type = "IdealAirSystemAbridged", EconomizerTypeEnum? economizerType = EconomizerTypeEnum.DifferentialDryBulb, bool demandControlledVentilation = false, double sensibleHeatRecovery = 0, double latentHeatRecovery = 0, double heatingAirTemperature = 50, double coolingAirTemperature = 13, AnyOfNoLimitAutosizenumber heatingLimit = default, AnyOfNoLimitAutosizenumber coolingLimit = default, string heatingAvailability = default, string coolingAvailability = default)
        {
