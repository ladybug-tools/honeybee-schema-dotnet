...
namespace HoneybeeSchema
{
    ...
    public partial class Room :  IEquatable<Room>, IValidatableObject
    {
        ...
        public Room(string identifier, string displayName = default, Object userData = default, List<Face> faces, List<Shade> indoorShades = default, List<Shade> outdoorShades = default, RoomPropertiesAbridged properties, int multiplier = 1)
        {
