...
namespace HoneybeeSchema
{
    ...
    public partial class ShadowCalculation :  IEquatable<ShadowCalculation>, IValidatableObject
    {
        ...
        public ShadowCalculation(string type = "ShadowCalculation", SolarDistributionEnum? solarDistribution = SolarDistributionEnum.FullInteriorAndExteriorWithReflections, int calculationFrequency = 30, CalculationMethodEnum? calculationMethod = CalculationMethodEnum.AverageOverDaysInFrequency, int maximumFigures = 15000)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShadowCalculation {\n");
