...
namespace HoneybeeSchema
{
    ...
    public partial class ShadowCalculation : HoneybeeObject, IEquatable<ShadowCalculation>, IValidatableObject
    {
        ...
        public CalculationMethod? CalculationMethod { get; set; }   = HoneybeeSchema.CalculationMethod.PolygonClipping; 
        /// <summary>
        ...
        public CalculationUpdateMethod? CalculationUpdateMethod { get; set; }   = HoneybeeSchema.CalculationUpdateMethod.Periodic; 
        /// <summary>
        ...
        /// <param name="calculationMethod">Text noting whether CPU-based polygon clipping method orGPU-based pixel counting method should be used. For low numbers of shadingsurfaces (less than ~200), PolygonClipping requires less runtime thanPixelCounting. However, PixelCounting runtime scales significantlybetter at higher numbers of shading surfaces. PixelCounting also hasno limitations related to zone concavity when used with any“FullInterior” solar distribution options. (default to &quot;PolygonClipping&quot;).</param>
        /// <param name="calculationUpdateMethod">Text describing how often the solar and shading calculations are updated with respect to the flow of time in the simulation. (default to &quot;Periodic&quot;).</param>
        ...
        (
             // Required parameters
            SolarDistribution? solarDistribution = HoneybeeSchema.SolarDistribution.FullExteriorWithReflections, CalculationMethod? calculationMethod = HoneybeeSchema.CalculationMethod.PolygonClipping, CalculationUpdateMethod? calculationUpdateMethod = HoneybeeSchema.CalculationUpdateMethod.Periodic, int calculationFrequency = 30, int maximumFigures = 15000// Optional parameters
        )// BaseClass
        {
            ...
            {
                this.CalculationMethod = HoneybeeSchema.CalculationMethod.PolygonClipping;
            }
            else
            {
                this.CalculationMethod = calculationMethod;
            }
            // use default value if no "calculationUpdateMethod" provided
            if (calculationUpdateMethod == null)
            {
                this.CalculationUpdateMethod = HoneybeeSchema.CalculationUpdateMethod.Periodic;
            }
            else
            {
