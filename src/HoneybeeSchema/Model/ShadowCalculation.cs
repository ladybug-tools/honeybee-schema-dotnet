...
namespace HoneybeeSchema
{
    ...
    public partial class ShadowCalculation : HoneybeeObject, IEquatable<ShadowCalculation>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="solarDistribution">solarDistribution (default to SolarDistributionEnum.FullExteriorWithReflections).</param>
        ...
        (
             // Required parameters
            SolarDistributionEnum? solarDistribution = SolarDistributionEnum.FullExteriorWithReflections, int calculationFrequency = 30, CalculationMethodEnum? calculationMethod = CalculationMethodEnum.AverageOverDaysInFrequency, int maximumFigures = 15000// Optional parameters
        )// BaseClass
        {
            // use default value if no "solarDistribution" provided
            if (solarDistribution == null)
            {
                this.SolarDistribution = SolarDistributionEnum.FullExteriorWithReflections;
            }
            else
            {
