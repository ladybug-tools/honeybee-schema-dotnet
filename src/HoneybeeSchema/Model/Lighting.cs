...
namespace HoneybeeSchema
{
    ...
    public partial class Lighting : IDdEnergyBaseModel, IEquatable<Lighting>
    {
        /// <summary>
        ...
        public Lighting
        (
            string identifier, double wattsPerArea, AnyOf<ScheduleRuleset, ScheduleFixedInterval> schedule, object userData = default, string displayName = default, double visibleFraction = 0.25D, double radiantFraction = 0.32D, double returnAirFraction = 0D, double baselineWattsPerArea = 11.84029D
