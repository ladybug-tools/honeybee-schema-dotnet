...
namespace HoneybeeSchema
{
    ...
    public partial class AddedInstruction : OpenAPIGenBaseModel, IEquatable<AddedInstruction>, IValidatableObject
    {
        /// <summary>
        ...
        public override string Type { get; protected set; }  = "AddedInstruction";
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^AddedInstruction$", RegexOptions.CultureInvariant);
