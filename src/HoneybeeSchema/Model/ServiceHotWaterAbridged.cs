...
namespace HoneybeeSchema
{
    ...
    public partial class ServiceHotWaterAbridged : IDdEnergyBaseModel, IEquatable<ServiceHotWaterAbridged>
    {
        /// <summary>
        ...
        (
            string identifier, double flowPerArea, string schedule, object userData = default, string displayName = default, double targetTemperature = 60D, double sensibleFraction = 0.2D, double latentFraction = 0.05D
