...
namespace HoneybeeSchema
{
    ...
    public partial class WSHPwithDOASAbridged : IDdEnergyBaseModel, IEquatable<WSHPwithDOASAbridged>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Vintages vintage= Vintages.ASHRAE_2013, double sensibleHeatRecovery = 0D, double latentHeatRecovery = 0D, bool demandControlledVentilation = false, string doasAvailabilitySchedule= default, WSHPwithDOASEquipmentType equipmentType= WSHPwithDOASEquipmentType.DOAS_WSHP_FluidCooler_Boiler// Optional parameters
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^WSHPwithDOASAbridged$", RegexOptions.CultureInvariant);
