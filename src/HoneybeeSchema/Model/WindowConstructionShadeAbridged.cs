...
namespace HoneybeeSchema
{
    ...
    public partial class WindowConstructionShadeAbridged : IDdEnergyBaseModel, IEquatable<WindowConstructionShadeAbridged>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, ShadeLocation shadeLocation= default, ControlType controlType= default, double setpoint= default, string schedule= default// Optional parameters
        ...
        {
            return FromJson(this.ToJson()) as WindowConstructionShadeAbridged;
        }
