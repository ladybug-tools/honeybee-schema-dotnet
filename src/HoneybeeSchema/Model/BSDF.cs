...
namespace HoneybeeSchema
{
    ...
    public partial class BSDF : ModifierBase, IEquatable<BSDF>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="BSDF" /> class.
        /// </summary>
        /// <param name="bsdfData">BSDF xml file data as bytes. (required).</param>
        ...
        /// <summary>
        /// BSDF xml file data as bytes.
        /// </summary>
        /// <value>BSDF xml file data as bytes.</value>
        [DataMember(Name="bsdf_data", EmitDefaultValue=false)]
        [JsonProperty("bsdf_data")]
        public System.IO.Stream BsdfData { get; set; }
        /// <summary>
        ...
        {
            return JsonConvert.DeserializeObject<BSDF>(json, new AnyOfJsonConverter());
        }
