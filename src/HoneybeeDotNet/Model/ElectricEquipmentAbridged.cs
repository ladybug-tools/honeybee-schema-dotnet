...
namespace HoneybeeDotNet.Model
{
    ...
    public partial class ElectricEquipmentAbridged :  IEquatable<ElectricEquipmentAbridged>, IValidatableObject
    {
        ...
        public ElectricEquipmentAbridged(string name, decimal wattsPerArea, string schedule, decimal radiantFraction = 0M, AnyOfnumberstring latentFraction = default(AnyOfnumberstring), decimal lostFraction = 0M, string type = "ElectricEquipmentAbridged")
        {
