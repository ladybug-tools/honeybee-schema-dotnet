...
namespace HoneybeeDotNet.Model
{
    ...
    public partial class ApertureEnergyPropertiesAbridged :  IEquatable<ApertureEnergyPropertiesAbridged>, IValidatableObject
    {
        ...
        public ApertureEnergyPropertiesAbridged(string type = "ApertureEnergyPropertiesAbridged", string construction = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApertureEnergyPropertiesAbridged {\n");
