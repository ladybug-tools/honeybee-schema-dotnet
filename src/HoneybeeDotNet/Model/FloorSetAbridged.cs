...
namespace HoneybeeDotNet.Model
{
    ...
    public partial class FloorSetAbridged :  IEquatable<FloorSetAbridged>, IValidatableObject
    {
        ...
        public FloorSetAbridged(string type = "FloorSetAbridged", string interiorConstruction = default(string), string exteriorConstruction = default(string), string groundConstruction = default(string))
        {
