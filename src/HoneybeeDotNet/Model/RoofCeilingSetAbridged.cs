...
namespace HoneybeeDotNet.Model
{
    ...
    public partial class RoofCeilingSetAbridged :  IEquatable<RoofCeilingSetAbridged>, IValidatableObject
    {
        ...
        public RoofCeilingSetAbridged(string type = "RoofCeilingSetAbridged", string interiorConstruction = default(string), string exteriorConstruction = default(string), string groundConstruction = default(string))
        {
