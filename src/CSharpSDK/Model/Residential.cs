...
namespace HoneybeeSchema
{
    ...
    [System.Serializable]
    [DataContract(Name = "Residential")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class Residential : HeatCoolBase, System.IEquatable<Residential>
    {
        /// <summary>
        ...
        public Residential
        (
            string identifier, string displayName = default, object userData = default, Vintages vintage = Vintages.ASHRAE_2019, ResidentialEquipmentType equipmentType = ResidentialEquipmentType.ResidentialAC_ElectricBaseboard
        ) : base(identifier: identifier, displayName: displayName, userData: userData, vintage: vintage)
        {
            ...
            if (this.GetType() == typeof(Residential))
