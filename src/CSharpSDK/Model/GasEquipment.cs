...
namespace HoneybeeSchema
{
    [Summary(@"")]
    [System.Serializable]
    [DataContract(Name = "GasEquipment")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class GasEquipment : IDdEnergyBaseModel, System.IEquatable<GasEquipment>
    {
        /// <summary>
        ...
        /// <param name="schedule">The schedule for the use of equipment over the course of the year. The type of this schedule should be Fractional and the fractional values will get multiplied by the watts_per_area to yield a complete equipment profile. If None, an Always On schedule will be used.</param>
        ...
        public GasEquipment
        (
            string identifier, double wattsPerArea, string displayName = default, object userData = default, AnyOf<ScheduleRuleset, ScheduleFixedInterval> schedule = default, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D
        ...
        /// </summary>
        [Summary(@"The schedule for the use of equipment over the course of the year. The type of this schedule should be Fractional and the fractional values will get multiplied by the watts_per_area to yield a complete equipment profile. If None, an Always On schedule will be used.")]
