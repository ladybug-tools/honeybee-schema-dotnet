...
namespace HoneybeeSchema
{
    ...
    [System.Serializable]
    [DataContract(Name = "NoLimit")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class NoLimit : OpenAPIGenBaseModel, System.IEquatable<NoLimit>
    {
        /// <summary>
        ...
        ) : base()
        {
            ...
            if (this.GetType() == typeof(NoLimit))
