...
namespace HoneybeeSchema
{
    ...
    public partial class Trans : ModifierBase, System.IEquatable<Trans>
    {
        ...
        // [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]  // For System.Text.Json  
        [Range(0, 1)]
        [DataMember(Name = "transmitted_diff")] // For internal Serialization XML/JSON
        [JsonProperty("transmitted_diff", NullValueHandling = NullValueHandling.Ignore)] // For Newtonsoft.Json
        ...
        // [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]  // For System.Text.Json  
        [Range(0, 1)]
        [DataMember(Name = "transmitted_spec")] // For internal Serialization XML/JSON
        [JsonProperty("transmitted_spec", NullValueHandling = NullValueHandling.Ignore)] // For Newtonsoft.Json
