...
namespace HoneybeeSchema
{
    ...
    public partial class VentilationAbridged : IDdEnergyBaseModel, System.IEquatable<VentilationAbridged>
    {
        ...
        (
            string identifier, string displayName = default, object userData = default, double flowPerPerson = 0D, double flowPerArea = 0D, double airChangesPerHour = 0D, double flowPerZone = 0D, string schedule = default, VentilationMethod method = VentilationMethod.Sum, double effectivenessCooling = 1D, double effectivenessHeating = 1D, double secondaryRecirculation = 0D
