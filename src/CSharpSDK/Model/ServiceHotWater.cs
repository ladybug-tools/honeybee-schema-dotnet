...
namespace HoneybeeSchema
{
    ...
    public partial class ServiceHotWater : IDdEnergyBaseModel, System.IEquatable<ServiceHotWater>
    {
        ...
        (
            string identifier, double flowPerArea, AnyOf<ScheduleRuleset, ScheduleFixedInterval> schedule, string displayName = default, object userData = default, double targetTemperature = 60D, double sensibleFraction = 0.2D, double latentFraction = 0.05D
        ) : base(identifier: identifier, displayName: displayName, userData: userData)
        {
            this.FlowPerArea = flowPerArea;
            this.Schedule = schedule ?? throw new System.ArgumentNullException("schedule is a required property for ServiceHotWater and cannot be null");
