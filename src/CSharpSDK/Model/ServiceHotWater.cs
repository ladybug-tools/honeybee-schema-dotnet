...
namespace HoneybeeSchema
{
    [Summary(@"")]
    [System.Serializable]
    [DataContract(Name = "ServiceHotWater")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class ServiceHotWater : IDdEnergyBaseModel, System.IEquatable<ServiceHotWater>
    {
        /// <summary>
        ...
        /// <param name="schedule">The schedule for the use of hot water over the course of the year. The type of this schedule should be Fractional and the fractional values will get multiplied by the flow_per_area to yield a complete water usage profile. If None, an Always On schedule will be used.</param>
        ...
        (
            string identifier, double flowPerArea, string displayName = default, object userData = default, AnyOf<ScheduleRuleset, ScheduleFixedInterval> schedule = default, double targetTemperature = 60D, double sensibleFraction = 0.2D, double latentFraction = 0.05D
        ...
        [DataMember(Name = "flow_per_area", IsRequired = true)] // For internal Serialization XML/JSON
        [JsonProperty("flow_per_area", Required = Required.Always)] // For Newtonsoft.Json
        ...
        /// </summary>
        [Summary(@"The schedule for the use of hot water over the course of the year. The type of this schedule should be Fractional and the fractional values will get multiplied by the flow_per_area to yield a complete water usage profile. If None, an Always On schedule will be used.")]
        ...
        // [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]  // For System.Text.Json  
        [Range(0, 1)]
        [DataMember(Name = "sensible_fraction")] // For internal Serialization XML/JSON
        [JsonProperty("sensible_fraction", NullValueHandling = NullValueHandling.Ignore)] // For Newtonsoft.Json
