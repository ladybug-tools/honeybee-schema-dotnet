import { IsInstance, ValidateNested, IsDefined, IsString, IsOptional, IsEnum, IsNumber, validate, ValidationError } from 'class-validator';
...
export class WindowConstructionShade extends IDdEnergyBaseModel {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            this.type = _data["type"] !== undefined ? _data["type"] : "WindowConstructionShade";
