...
import { RadianceSubFaceStateAbridged } from "./RadianceSubFaceStateAbridged.ts";
...
export class DoorRadiancePropertiesAbridged extends _PropertiesBaseAbridged {
    ...
    override init(_data?: any) {
        super.init(_data);
        if (_data) {
            const obj = plainToClass(DoorRadiancePropertiesAbridged, _data, { enableImplicitConversion: true });
            this.type = obj.type;
