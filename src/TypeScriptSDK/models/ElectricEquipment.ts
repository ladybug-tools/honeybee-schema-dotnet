import { IsNumber, IsDefined, IsOptional, IsString, validate, ValidationError } from 'class-validator';
...
export class ElectricEquipment extends IDdEnergyBaseModel {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            this.type = _data["type"] !== undefined ? _data["type"] : "ElectricEquipment";
        }
    }
