import { IsString, IsOptional, Equals, MinLength, MaxLength, IsInstance, ValidateNested, validate, ValidationError as TsValidationError } from 'class-validator';
...
export class ApertureEnergyPropertiesAbridged extends _OpenAPIGenBaseModel {
    ...
    @IsString()
    @IsOptional()
    @Equals("ApertureEnergyPropertiesAbridged")
    @Expose({ name: "type" })
    /** type */
