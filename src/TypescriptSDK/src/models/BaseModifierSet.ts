...
export class BaseModifierSet extends _OpenAPIGenBaseModel {
    ...
    override init(_data?: any) {
        super.init(_data);
        if (_data) {
            const obj = plainToClass(BaseModifierSet, _data, { enableImplicitConversion: true, exposeUnsetFields: false, exposeDefaultValues: true });
	...
	override toJSON(data?: any) {
        ...
        data["type"] = this.type ?? "BaseModifierSet";
