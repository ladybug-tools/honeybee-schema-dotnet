import { IsString, IsOptional, Equals, IsNumber, Min, Max, MinLength, MaxLength, validate, ValidationError as TsValidationError } from 'class-validator';
...
export class VentilationControlAbridged extends _OpenAPIGenBaseModel {
    ...
    @IsString()
    @IsOptional()
    @Equals("VentilationControlAbridged")
    @Expose({ name: "type" })
    /** type */
