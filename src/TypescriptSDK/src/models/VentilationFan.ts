...
export class VentilationFan extends EnergyBaseModel {
    @IsNumber()
    @IsDefined()
    @Expose({ name: "flow_rate" })
    /** A number for the flow rate of the fan in m3/s. */
    flowRate!: number;
	
    @IsNumber()
    @IsDefined()
    @Expose({ name: "pressure_rise" })
    ...
    ventilationType: VentilationType = VentilationType.Balanced;
    ...
    constructor() {
        ...
        this.ventilationType = VentilationType.Balanced;
    }
