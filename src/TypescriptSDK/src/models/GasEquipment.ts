...
export class GasEquipment extends IDdEnergyBaseModel {
    ...
    override init(_data?: any) {
        super.init(_data);
        if (_data) {
            const obj = plainToClass(GasEquipment, _data, { enableImplicitConversion: true, exposeUnsetFields: false, exposeDefaultValues: true });
            ...
            this.type = obj.type ?? "GasEquipment";
        }
    }
	...
	override toJSON(data?: any) {
        ...
        data["type"] = this.type ?? "GasEquipment";
