...
${nuget_cmd} install src/HoneybeeSchema/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/HoneybeeSchema.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/HoneybeeSchema.dll \
-recurse:'src/HoneybeeSchema/*.cs' \
-doc:bin/HoneybeeSchema.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/HoneybeeSchema.dll was created successfully"
fi
