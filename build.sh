...
${nuget_cmd} install src/HoneybeeDotNet/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/HoneybeeDotNet.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/HoneybeeDotNet.dll \
-recurse:'src/HoneybeeDotNet/*.cs' \
-doc:bin/HoneybeeDotNet.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/HoneybeeDotNet.dll was created successfully"
fi
