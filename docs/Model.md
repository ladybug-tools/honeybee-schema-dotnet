...
**Version** | **string** | Text string for the current version of the schema. | [optional] [readonly] [default to "1.54.1"]
...
**ShadeMeshes** | [**List&lt;ShadeMesh&gt;**](ShadeMesh.md) | A list of ShadeMesh in the model. | [optional] 
