...
**PeoplePerArea** | **decimal** | People per floor area expressed as [people/m2] | 
...
**RadiantFraction** | **decimal** | The radiant fraction of sensible heat released by people. The defaultvalue is 0.30. | [optional] [default to 0.3M]
