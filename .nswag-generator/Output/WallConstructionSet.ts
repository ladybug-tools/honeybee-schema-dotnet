import { IsInstance, ValidateNested, IsOptional, IsString, validate, ValidationError } from 'class-validator';
...
export class WallConstructionSet extends _OpenAPIGenBaseModel {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            this.type = _data["type"] !== undefined ? _data["type"] : "WallConstructionSet";
        }
    }
